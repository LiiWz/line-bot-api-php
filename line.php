  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอด COVID-19")||($text == "ยอด COVID-19")||($text == "COVID-19")){
			//$temp = 27;
			$reply_message = "รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย \/n/ ผู้ป่วยสะสม จำนวน 398,995 ราย \/n/ ผู้เสียชีวิต จำนวน 17,365 ราย \/n/ รักษาหาย จำนวน 103,753 ราย \/n/ ผู้รายงานข้อมูล: นายศศลักษณ์ น่วมสีนวน";
		}
