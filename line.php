  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอด COVID-19")||($text == "ยอด COVID-19")||($text == "COVID-19")){
			...
			$reply_message += "ผู้ป่วยสะสม จำนวน 398,995 ราย <br>";
			$reply_message += "ผู้เสียชีวิต	จำนวน 17,365 ราย <br>";
			$reply_message += "รักษาหาย จำนวน 103,753 ราย <br>";
			$reply_message += "ผู้รายงานข้อมูล: นายกานต์ เจริญจิตร";
		}
		else if(($text== "ข้อมูลส่วนตัวของผู้พัฒนาระบบ")||($text== "ผู้พัฒนาระบบ")||($text== "ข้อมูลส่วนตัว")){
			$reply_message = "ชื่อศศลักษณ์ น่วมสีนวน อายุ 23ปี น้ำหนัก 57kg. สูง 168cm. ขนาดรองเท้าเบอร์ 41 ใช้หน่วย UK";
		}
		else
		{
